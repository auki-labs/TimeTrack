...
const ASANA_PROJECTGID = [1205295625655028,1205324013351705,1205324013351713,1205298958054578]
async function getTaskDetails(id,token) {
  try {
    const response = await axios.get(`https://app.asana.com/api/1.0/tasks/${id}`, {
      headers: {
        Authorization: token,
      },
    });
